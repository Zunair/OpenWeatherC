...
namespace OpenWeather
{
    ...
    internal static class XmlTools
    {
        ...
        internal static string GetAttributeValue(string attribute, XDocument doc, params string[] elements)
        {
        ...
        /// <param name="elements">Name of elements to navigate.</param>
        /// <returns>The value from the attribute as a string.</returns>
        internal static string GetElementContent(string targetElement, XDocument doc, params string[] elements)
        {
            string retVal = string.Empty;
            try
            {
                retVal = GetNode(doc, elements).Element(targetElement)?.Value;
            }
            catch (System.Exception ex  )
            {
                ...
                if (ex.InnerException != null)
                    System.Console.WriteLine("InnerStackTrace: " + ex.InnerException.StackTrace != null ? ex.InnerException.StackTrace : string.Empty);
        ...
        /// <param name="elements">Name of elements to navigate.</param>
        /// <returns></returns>
        internal static XElement GetNode(XDocument doc, params string[] elements)
        {
            var node = doc.Root;
        ...
        internal static XDocument TruncateXDocument(XDocument doc, string element, string attribute, string value)
        {
            var node = doc.Root;
