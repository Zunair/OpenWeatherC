...
namespace OpenWeather
{
    ...
    public sealed class TafStation : Station
    {
        ...
        internal override string GenerateLookupUrl() => $"http://forecast.weather.gov/MapClick.php?lat={GetStationInfo.Location.Latitude}&lon={GetStationInfo.Location.Longitude}&FcstType=dwml";
    }
}